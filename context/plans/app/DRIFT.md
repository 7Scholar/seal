...
- changed ui/App.tsx
  5c9bc56 (5 files) "ui: give the manage surface a scanning state and its own failure"

## desktop/ui/errors.md
...
- changed ui/styles.css
  5c9bc56 (5 files) "ui: give the manage surface a scanning state and its own failure"
  73818d0 (5 files) "ui: rebuild the manage surface frame, and make every folder row respond"
...
- changed ui/components/FileTree.tsx
  73818d0 (5 files) "ui: rebuild the manage surface frame, and make every folder row respond"
