...
- changed e2e/journeys/editing.e2e.ts
...
- e2e/journeys/row-density.e2e.ts
  c8c07b4 (born) "row-density: collapse eight controls to three and a menu"
- e2e/wdio.rowdensity.conf.ts
  c8c07b4 (born) "row-density: collapse eight controls to three and a menu"
- ui/components/RowToolbar.tsx
  c8c07b4 (born) "row-density: collapse eight controls to three and a menu"
