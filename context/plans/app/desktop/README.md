...
Reaching the ninth exposed the most serious defect this axis has found: **a master-password change leaves the vault openable by neither password.** It is framed in `ui/password-change.md`, which is no longer complete as a result.
