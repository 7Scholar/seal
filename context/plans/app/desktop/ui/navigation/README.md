...
- [~] editing/ -> the full editing vocabulary for an env file: create, rename, delete, duplicate, reorder, and commented-out variables as a disabled state. **Five of six children are complete and driven against the real application; `bulk-entry.md` is framed and unstarted.**
