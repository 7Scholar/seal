...
- [x] value-as-button.md -> the value itself as the row's control: one press reveals, a second edits, Escape puts it back, and the Reveal and Edit controls come off every row
